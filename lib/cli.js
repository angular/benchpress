var fs = require('fs'),
    ...
    underscoreBase = path.dirname(require.resolve('underscore')),
    underscoreMapPath = path.resolve(underscoreBase, 'underscore-min.map'),
    underscorePath = path.resolve(underscoreBase, 'underscore-min.js'),
    bootstrapBase = path.resolve(require.resolve('bootstrap'), '../../..'),
    bootstrapPath = path.resolve(bootstrapBase, 'dist/css/bootstrap.min.css'),
