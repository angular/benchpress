/**
 * @license AngularJS v1.3.1-local+sha.0c8561c
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.1-local+sha.0c8561c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.1-local+sha.0c8561c',    // all of these placeholder strings will be replaced by grunt's
